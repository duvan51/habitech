                            ...
                            <div className="flex-1 grid grid-cols-1 lg:grid-cols-3 gap-6 min-h-0">
                                        ...
                                        <div>
                                            <div className="flex items-center justify-between mb-1">
                                                ...
                                                <button
                                                    ...
                                                    className="text-[10px] bg-white hover:bg-gray-50 text-gray-700 px-3 py-1 rounded-full border border-gray-200 transition-all flex items-center gap-1 shadow-sm"
                                                >
                                                    📍 Usar GPS
                                                </button>
                                            </div>
                                            <input
                                                ...
                                                required
                                                readOnly
                                                className="block w-full border-gray-200 bg-gray-50 rounded-lg py-2.5 px-3 text-sm cursor-default"
                                                value={formData.location}
                                                placeholder="Selecciona un punto en el mapa..."
                                            />
                                            <p className="mt-1.5 text-[10px] text-gray-400 italic">El nombre se genera automáticamente al tocar el mapa.</p>
                                        </div>
                                ...
                                <div className="lg:col-span-2 h-[300px] lg:h-full flex flex-col">
                                    <div className="flex-1 bg-gray-100 rounded-2xl overflow-hidden border border-gray-200 relative shadow-inner">
                                        ...
                                        <div className="absolute top-4 right-4 z-[1000] bg-white/90 backdrop-blur-md px-4 py-2 rounded-xl shadow-xl border border-white flex items-center gap-2">
                                            <div className="w-2 h-2 bg-green-500 animate-pulse rounded-full"></div>
                                            <span className="text-[11px] font-bold text-gray-700">Mapa Activo: Toca para ubicar</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
