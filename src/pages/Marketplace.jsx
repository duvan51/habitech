            ...
            <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
                <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-12 gap-6">
                    ...
                    <div className="flex gap-3">
                        <Link to="/register" className="bg-white text-orange-600 px-6 py-2.5 rounded-lg font-bold border-2 border-orange-600 hover:bg-orange-600 hover:text-white transition-all shadow-sm">
                            Publicar Ahora
                        </Link>
                    </div>
                </div>
                ...
                {loading ? (
                    ...
                    <div className="text-center py-20 bg-white rounded-2xl shadow-sm border border-gray-100">
                        ...
                        <Link to="/register" className="mt-6 inline-block bg-orange-600 text-white px-8 py-3 rounded-xl font-bold shadow-lg shadow-orange-200 hover:bg-orange-700 transition-all">
